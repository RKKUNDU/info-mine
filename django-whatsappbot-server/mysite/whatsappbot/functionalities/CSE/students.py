...
class Students:
    def show_students(self, batch, with_interests = False, with_advisor = False):
        ...
        try:
            ...
            if with_advisor and with_interests:
                return (tabulate(table, headers = ['User ID', 'Name', 'Advisor', 'Interests']))
            elif with_advisor:
                return (tabulate(table, headers = ['User ID', 'Name', 'Advisor']))
            elif with_interests:
                return (tabulate(table, headers = ['User ID', 'Name', 'Interests']))
            else:
                return (tabulate(table, headers = ['User ID', 'Name']))
    ...
    def show_filtered_students(self, batch,
        ...
        try:
            ...
            if with_advisor and with_interests and cnt > 0:
                ...
                return ("No student found with this filter. Please try with some other filter")
